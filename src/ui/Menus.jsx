...
//   /* Destructuring with default values for position */
...
function Menus({ children }) {
  ...
  return (
    <MenuContext.Provider value={{ openId, close, open, setPositon, position }}>
      <span>{children}</span>
...
function Toggle({ id }) {
  const { openId, close, open, setPositon } = useContext(MenuContext);
